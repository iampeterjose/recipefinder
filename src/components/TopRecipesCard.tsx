...
function TopRecipesCard({ recipe }: Props) {
  return (
    <div className="min-w-[320px] max-w-xs flex-shrink-0 snap-center bg-white rounded-3xl shadow-xl hover:shadow-2xl transition transform hover:-translate-y-1 p-6 flex flex-col items-center border border-indigo-100 group">
      ...
      <h3 className="text-2xl font-bold text-indigo-800 mb-2 text-center">{recipe.name}</h3>
